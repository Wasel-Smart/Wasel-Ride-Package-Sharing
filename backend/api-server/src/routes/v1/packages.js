...
router.post('/', authenticate, validate(CreatePackageSchema), async (req, res) => {
    try {
...
router.post('/:id/assign-to-trip', authenticate, async (req, res) => {
    try {
...
router.post('/:id/status', authenticate, validate(UpdateStatusSchema), async (req, res) => {
    try {
