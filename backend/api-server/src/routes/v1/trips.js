...
router.post('/', authenticate, requireRole(['driver', 'admin']), validate(CreateTripSchema), async (req, res) => {
    try {
...
router.post('/:id/book', authenticate, validate(BookTripSchema), async (req, res) => {
    try {
