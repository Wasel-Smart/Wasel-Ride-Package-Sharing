...
interface RuntimeHealthServerOptions {
  serviceName: string;
  port?: number;
...
export function startRuntimeHealthServer(options: RuntimeHealthServerOptions): RuntimeHealthServer {
      ...
      if (request.url === '/metrics') {
        ...
        response.end(
          options.metrics
            ...
            : `wasel_service_uptime_seconds{service="${options.serviceName}"} ${Math.round(
