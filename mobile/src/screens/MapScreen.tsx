...
function MapScreen() {
  ...
  const mapWidth = Math.max(280, screenWidth - spacing.lg * 2);
  ...
  const getCorridorPath = (corridor: Corridor): { x1: number; y1: number; x2: number; y2: number } => {
    ...
    return {
      x1: fromCity.x * mapWidth,
      y1: fromCity.y * MAP_HEIGHT,
      x2: toCity.x * mapWidth,
  ...
  return (
    <ScreenShell testID="map-screen">
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <SectionHeader
          eyebrow="نظام الحركة"
          title="خريطة شبكة الأردن"
          body="مشاوير وطرود مباشرة بين المدن لحظة بلحظة."
        />
        ...
        <View style={styles.globalStats}>
          <View style={[styles.statPill, { backgroundColor: `${colors.teal}14` }]}>
            ...
            <Text style={styles.statLabel}>مشاوير</Text>
          </View>
          <View style={[styles.statPill, { backgroundColor: `${colors.blue}14` }]}>
            ...
            <Text style={styles.statLabel}>طرود</Text>
          </View>
          <View style={[styles.statPill, { backgroundColor: `${colors.gold}14` }]}>
            ...
            <Text style={styles.statLabel}>خطوط نشطة</Text>
          </View>
        </View>

        <PremiumPanel tone="dark" style={styles.mapContainer}>
          <View style={styles.mapHeader}>
            <Text style={styles.mapTitle}>شبكة النقل الوطنية</Text>
            <StatusPill
              label={selectedCity ? `مفلتر: ${selectedCityData?.name}` : 'كل المدن'}
          ...
          <View style={styles.mapLegend}>
            <View style={styles.legendItem}>
              ...
              <Text style={styles.legendText}>طلب مرتفع</Text>
            </View>
            <View style={styles.legendItem}>
            ...
            <View style={styles.legendItem}>
              ...
              <Text style={styles.legendText}>العاصمة</Text>
            </View>
          </View>
        </PremiumPanel>
          ...
          <View style={styles.cityDetailPanel}>
            ...
            <View style={styles.cityMetrics}>
              <View style={styles.cityMetric}>
                ...
                <Text style={styles.cityMetricLabel}>مشاوير</Text>
              </View>
              <View style={styles.cityMetric}>
                <Text style={styles.cityMetricValue}>
                  {selectedCorridors.reduce((sum, c) => sum + c.packages, 0).toLocaleString()}
                </Text>
                <Text style={styles.cityMetricLabel}>طرود</Text>
              </View>
              <View style={styles.cityMetric}>
                <Text style={styles.cityMetricValue}>{selectedCityData.population}</Text>
                <Text style={styles.cityMetricLabel}>السكان</Text>
              </View>
            </View>

            <Text style={styles.cityDetailSection}>الخطوط النشطة</Text>
            {selectedCorridors
        ...
        {!selectedCityData && (
          <View style={styles.topCorridors}>
            <SectionHeader
              eyebrow="أكثر الخطوط حركة"
              title="أعلى الخطوط"
              body="أكثر الخطوط طلباً في الأردن"
            />
            {CORRIDORS
        ...
        <InfoCard
          icon="git-network"
          title="شبكة تغطي الأردن"
          body="المشاوير والطرود بتربط أهم ١٠ مدن. اضغط على أي مدينة أو خط لتشوف الطلب والسعر والمدة."
          tone={colors.cyan}
        />
      </ScrollView>
    </ScreenShell>
