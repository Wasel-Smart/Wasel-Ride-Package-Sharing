    ...
    setMessages([
      {
        ...
        text: 'أهلاً، أنا السائق تبعك. بوصل خلال دقائق.',
    ...
    >
      ...
      <View style={styles.header}>
        <View style={styles.headerInfo}>
          ...
          <View>
            ...
            <Text style={styles.headerSub}>مشوار #{rideId.slice(-6)}</Text>
          </View>
        </View>
        <TouchableOpacity onPress={onClose} style={styles.closeBtn} accessibilityLabel="إغلاق الدردشة">
      ...
      <View style={styles.inputBar}>
        ...
        <TouchableOpacity
          ...
          accessibilityLabel="إرسال رسالة"
...
const styles = StyleSheet.create({
  ...
  headerName: { color: colors.ink, ...typography.body, fontWeight: '900' },
  headerSub: { color: colors.muted, ...typography.caption },
  ...
  senderName: { color: colors.muted, ...typography.caption, fontWeight: '800', marginBottom: 3 },
