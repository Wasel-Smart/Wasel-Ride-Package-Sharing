const a="var(--wasel-font-display, 'Plus Jakarta Sans', 'Montserrat', 'Cairo', 'Tajawal', sans-serif)",r=a,t=a,n={text:"var(--wasel-copy-primary)",muted:"var(--wasel-copy-muted)",soft:"var(--wasel-copy-soft)",cyan:"var(--ds-accent, #f59a2c)",gold:"var(--ds-warning, #efb45d)",border:"var(--ds-border, #313841)"},e=n,o=(i=28)=>({borderRadius:i,background:"var(--wasel-panel-strong)",border:`1px solid ${n.border}`,boxShadow:"var(--wasel-shadow-lg)",backdropFilter:"blur(22px)"}),l=`
...
`;export{a as F,r as L,l as a,t as b,e as c,o as p};
