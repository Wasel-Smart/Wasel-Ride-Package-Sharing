-- Rollback for 20260401093000_database_hardening.sql
-- Generated: 2026-06-14T05:55:54.964Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260401093000_database_hardening.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260401093000_database_hardening.sql completed at %', NOW();
END $$;
