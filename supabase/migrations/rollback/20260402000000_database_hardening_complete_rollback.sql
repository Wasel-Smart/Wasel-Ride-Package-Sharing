-- Rollback for 20260402000000_database_hardening_complete.sql
-- Generated: 2026-06-14T05:55:55.037Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260402000000_database_hardening_complete.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260402000000_database_hardening_complete.sql completed at %', NOW();
END $$;
