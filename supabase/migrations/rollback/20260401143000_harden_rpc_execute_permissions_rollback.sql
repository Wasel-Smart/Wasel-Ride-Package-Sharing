-- Rollback for 20260401143000_harden_rpc_execute_permissions.sql
-- Generated: 2026-06-14T05:55:55.019Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260401143000_harden_rpc_execute_permissions.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260401143000_harden_rpc_execute_permissions.sql completed at %', NOW();
END $$;
