-- Rollback for 20260512000000_database_excellence_upgrade.sql
-- Generated: 2026-06-14T05:55:55.050Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260512000000_database_excellence_upgrade.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260512000000_database_excellence_upgrade.sql completed at %', NOW();
END $$;
