-- Rollback for 20260516071816_new-migration.sql
-- Generated: 2026-06-14T05:55:55.066Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260516071816_new-migration.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260516071816_new-migration.sql completed at %', NOW();
END $$;
