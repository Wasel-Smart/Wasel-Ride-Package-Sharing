-- Rollback for 20260320000000_w_mobility_platform_complete.sql
-- Generated: 2026-06-14T05:55:54.938Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260320000000_w_mobility_platform_complete.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260320000000_w_mobility_platform_complete.sql completed at %', NOW();
END $$;
