-- Rollback for 20260326080000_legacy_public_table_cutover.sql
-- Generated: 2026-06-14T05:55:54.947Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260326080000_legacy_public_table_cutover.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260326080000_legacy_public_table_cutover.sql completed at %', NOW();
END $$;
