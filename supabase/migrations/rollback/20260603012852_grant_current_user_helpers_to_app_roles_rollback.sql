-- Rollback for 20260603012852_grant_current_user_helpers_to_app_roles.sql
-- Generated: 2026-06-14T05:55:55.071Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260603012852_grant_current_user_helpers_to_app_roles.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260603012852_grant_current_user_helpers_to_app_roles.sql completed at %', NOW();
END $$;
