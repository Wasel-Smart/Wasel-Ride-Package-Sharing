-- Rollback for 20260401193000_referrals_and_growth_events.sql
-- Generated: 2026-06-14T05:55:55.026Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260401193000_referrals_and_growth_events.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260401193000_referrals_and_growth_events.sql completed at %', NOW();
END $$;
