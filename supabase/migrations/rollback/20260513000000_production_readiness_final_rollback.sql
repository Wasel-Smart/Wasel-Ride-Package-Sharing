-- Rollback for 20260513000000_production_readiness_final.sql
-- Generated: 2026-06-14T05:55:55.054Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260513000000_production_readiness_final.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260513000000_production_readiness_final.sql completed at %', NOW();
END $$;
