-- Rollback for 20260327110000_notifications_runtime_contract.sql
-- Generated: 2026-06-14T05:55:54.957Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260327110000_notifications_runtime_contract.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260327110000_notifications_runtime_contract.sql completed at %', NOW();
END $$;
