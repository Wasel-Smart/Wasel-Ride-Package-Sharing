-- Rollback for 20260516075253_add_departure_date_to_trips.sql
-- Generated: 2026-06-14T05:55:55.068Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260516075253_add_departure_date_to_trips.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260516075253_add_departure_date_to_trips.sql completed at %', NOW();
END $$;
