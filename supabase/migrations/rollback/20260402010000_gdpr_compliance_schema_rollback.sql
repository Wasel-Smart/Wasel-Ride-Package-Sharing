-- Rollback for 20260402010000_gdpr_compliance_schema.sql
-- Generated: 2026-06-14T05:55:55.045Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260402010000_gdpr_compliance_schema.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260402010000_gdpr_compliance_schema.sql completed at %', NOW();
END $$;
