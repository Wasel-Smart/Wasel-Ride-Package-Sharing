-- Rollback for 20260327090000_production_operating_model.sql
-- Generated: 2026-06-14T05:55:54.951Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260327090000_production_operating_model.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260327090000_production_operating_model.sql completed at %', NOW();
END $$;
