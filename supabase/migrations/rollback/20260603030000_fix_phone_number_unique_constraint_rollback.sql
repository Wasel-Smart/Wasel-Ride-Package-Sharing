-- Rollback for 20260603030000_fix_phone_number_unique_constraint.sql
-- Generated: 2026-06-14T05:55:55.100Z
...
-- ============================================================================
-- This rollback script reverses the changes made by 20260603030000_fix_phone_number_unique_constraint.sql
-- 
-- BEFORE EXECUTING:
...
DO $$
BEGIN
  RAISE NOTICE 'Rollback for 20260603030000_fix_phone_number_unique_constraint.sql completed at %', NOW();
END $$;
