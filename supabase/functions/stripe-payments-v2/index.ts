...
async function publishEvent(admin: ReturnType<typeof getAdminClient>, event: Record<string, unknown>) {
  try {
    ...
    console.warn('Failed to publish event to outbox', e instanceof Error ? e.message : 'unknown');
  }
}
