...
// 2. Backend Services (1.5 points)
console.log('\n🔧 Backend Services');
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
check('Backend', 'Supabase client configured', existsSync('src/utils/supabase/client.ts'), 0.3);
check('Backend', 'Edge function proxy', existsSync('supabase/functions/make-server-0b1f4071/index.ts'), 0.3);
check('Backend', 'Event broker (Supabase Realtime + Postgres outbox)', existsSync('src/platform/event-broker.ts'), 0.3);
check('Backend', 'Docker Compose local dev', existsSync('docker-compose.yml'), 0.3);
check('Backend', 'Atomic wallet withdrawal RPC', existsSync('supabase/migrations/20260709000000_atomic_wallet_withdrawal.sql'), 0.3);

// 3. Deployment & Infrastructure (1.5 points)
console.log('\n☸️  Deployment & Infrastructure');
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
check('Infra', 'Vercel deployment config', existsSync('vercel.json'), 0.3);
check('Infra', 'Docker Compose local', existsSync('docker-compose.yml'), 0.3);
check('Infra', 'CI pipeline', existsSync('.github/workflows/ci.yml'), 0.3);
check('Infra', 'Security scanning', existsSync('.github/workflows/security.yml'), 0.3);
check('Infra', 'Prettier formatting', existsSync('.prettierrc'), 0.3);
...
check('Docs', 'Security audit', existsSync('docs/HONEST_AUDIT_REPORT.md'), 0.1);
