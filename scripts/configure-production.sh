...
set_env "VITE_SUPABASE_PUBLISHABLE_KEY" "$VITE_SUPABASE_ANON_KEY" # Often the same as anon key
set_env "VITE_EDGE_FUNCTION_NAME" "make-server-0b1f4071"
set_env "VITE_API_URL" "${VITE_SUPABASE_URL}/functions/v1/make-server-0b1f4071"
...
echo ""
echo "4. App URLs"
set_env "VITE_APP_URL" "https://wasel14.online"
set_env "VITE_PRODUCTION_APP_URL" "https://wasel14.online"
...
set_env "VITE_GOOGLE_MAPS_API_KEY" "$VITE_GOOGLE_MAPS_API_KEY"
...
# Supabase (fill in from your Supabase project settings)
VITE_SUPABASE_URL=
...
# Google (fill in from Google Cloud Console)
VITE_GOOGLE_MAPS_API_KEY=
VITE_GOOGLE_CLIENT_ID=

# Stripe (fill in from Stripe Dashboard)
