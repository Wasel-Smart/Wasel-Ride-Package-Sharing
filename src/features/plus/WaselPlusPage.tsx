    ...
    <Protected>
      <PageShell>
        <SectionHead
          ...
          title={tx('waselPlusPage.wasel_plus')}
          titleAr="واصل بلس"
          sub={
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
              ...
              <div style={{ color: C.text, fontWeight: 900 }}>{tx('waselPlusPage.your_plan')}</div>
            </div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
              ...
              <div style={{ color: C.text, fontWeight: 900 }}>{tx('waselPlusPage.benefits')}</div>
            </div>
            <div style={{ display: 'grid', gap: 10 }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
            ...
            <div style={{ color: C.text, fontWeight: 900 }}>
              {tx('waselPlusPage.commuter_passes_on_strategic_corridors')}
            </div>
          </div>
          <div
            className="sp-2col"
          ...
          >
            {featuredCorridors.map(corridor => {
              ...
              const liveSignal =
                routeIntelligence.allSignals.find(s => s.id === corridor.id) ?? null;
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
              ...
              <div style={{ color: C.text, fontWeight: 900 }}>
                {tx('waselPlusPage.suggested_recurring_routes')}
              </div>
            </div>
            {retentionMessage && (
              <div
              ...
              {recurringSuggestions.map(suggestion => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {suggestion.priceQuote.finalPriceJod} JOD · {suggestion.recommendedFrequency}{' '}
                      {tx('waselPlusPage.at')}
                    ...
                    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 10 }}>
                      ...
                      >
                        {tx('driverPageExpanded.openRoute')}
                      </button>
                    </div>
                  </div>
                );
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
              ...
              <div style={{ color: C.text, fontWeight: 900 }}>
                {tx('waselPlusPage.saved_reminders')}
                {savedReminders.length > 0 && `(${savedReminders.length})`}
              </div>
            </div>
            {savedReminders.length > 0 ? (
              ...
              <div style={{ color: DS.sub, fontSize: '0.8rem', lineHeight: 1.65 }}>
                {tx('waselPlusPage.save_a_route_suggestion_to_see_reminders_here')}
              </div>
            )}
          </div>
        </div>
