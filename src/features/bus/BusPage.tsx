          ...
          <div className="sp-side-column" style={{ display: 'flex', flexDirection: 'column', gap: 16, position: 'sticky', top: 16 }}>
            <div style={{ background: 'linear-gradient(180deg, rgba(255,255,255,0.045), rgba(255,255,255,0.03))', border: `1px solid ${(activeBus.color ?? DS.cyan)}30`, borderRadius: r(22), overflow: 'hidden', boxShadow: `0 16px 42px ${activeBus.color ?? DS.cyan}10` }}>
              ...
              <div style={{ padding: 22, display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                {activeBus.seats === 0 && <div style={{ background: 'rgba(255,138,0,0.10)', border: '1px solid rgba(255,138,0,0.28)', borderRadius: r(16), padding: '14px 16px', color: '#fff', fontSize: '0.84rem', lineHeight: 1.5 }}>This coach is full right now. Switch routes and keep the same corridor filters.</div>}
                ...
                <div style={{ background: 'linear-gradient(135deg, rgba(8,125,255,0.08), rgba(255,138,0,0.08))', border: `1px solid ${DS.border}`, borderRadius: r(16), padding: '16px 16px 14px', boxShadow: '0 10px 24px rgba(0,0,0,0.12)' }}>
