...
const walletTextSource = {
  en: {
    ...
    refreshed: 'Refreshed',
    paymentCompleted: 'Payment completed. Wallet balance is refreshing.',
    paymentCancelled: 'Payment was cancelled before completion.',
    redirectingToPaymentCheckout: 'Redirecting to secure payment checkout',
    toppedUpSuccess: 'JOD {amount} added successfully',
    withdrawnSuccess: 'JOD {amount} withdrawn successfully',
    sentSuccess: 'JOD {amount} sent successfully',
  ...
  ar: {
    ...
    paymentCompleted: 'اكتمل الدفع. جارٍ تحديث رصيد المحفظة.',
    paymentCancelled: 'تم إلغاء الدفع قبل الاكتمال.',
    redirectingToPaymentCheckout: 'جارٍ تحويلك إلى صفحة دفع آمنة',
    toppedUpSuccess: 'تمت إضافة {amount} دينار بنجاح',
    withdrawnSuccess: 'تم سحب {amount} دينار بنجاح',
    sentSuccess: 'تم إرسال {amount} دينار بنجاح',
