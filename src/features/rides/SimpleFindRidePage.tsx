        ...
        <div style={{ display: 'grid', gap: '16px' }}>
          {rides.map(ride => (
            <div
              ...
              style={{
                background: selectedRide === ride.id ? C.cyanDim : C.card,
                border:
                  selectedRide === ride.id ? `1px solid ${C.cyanGlow}` : `1px solid ${C.border}`,
                borderRadius: '16px',
                padding: '20px',
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ color: C.textMuted, fontSize: '0.9rem' }}>{ride.time}</span>
                  </div>
