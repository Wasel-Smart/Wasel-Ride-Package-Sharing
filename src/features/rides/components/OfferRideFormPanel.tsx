    ...
    >
      ...
      {step === 2 && (
        <div style={{ display: 'grid', gap: 14 }}>
              ...
              {[
                {
                  ...
                  detail: 'Cheaper than solo movement while protecting fill rate',
                },
                {
                  label: 'Full route gross',
                  value: `${driverPlan.grossWhenFullJod} JOD`,
                  detail: `${driverPlan.corridor.fillTargetSeats} seats is the target load for this corridor`,
                },
                {
                  label: 'Best pickup point',
                  value:
                    liveSignal?.recommendedPickupPoint ??
                    driverPlan.corridor.pickupPoints[0] ??
                    'Trusted corridor node',
          ...
          {[
            { label: 'Available Seats', key: 'seats' as const, min: 1, max: 7 },
            { label: 'Price per Seat (JOD)', key: 'price' as const, min: 1, max: 50 },
          ].map(field => (
            <div key={field.label}>
              <label
                style={{
          ...
          {driverPlan && (
            ...
            >
              ...
              <div style={{ color: DS.sub, fontSize: '0.76rem', lineHeight: 1.6, marginTop: 6 }}>
                {driverPlan.waselBrainNote} Empty-seat risk is about {driverPlan.emptySeatCostJod}{' '}
                JOD per open seat, and package-ready supply can add about{' '}
                {driverPlan.packageBonusJod} JOD on this route.
                {liveSignal
        ...
        <div style={{ display: 'grid', gap: 14 }}>
          ...
          {form.acceptsPackages && (
            <div>
              ...
              <input
                placeholder="Example: compact parcels only"
          ...
          >
            ...
            <div style={{ color: C.text, fontSize: '0.9rem', lineHeight: 1.8 }}>
              ...
              <br />
              {form.acceptsPackages
                ? `Packages enabled (${form.packageCapacity})`
                : 'Passengers only'}
              {driverPlan && (
                <>
                  <br />
                  Wasel Brain target: {driverPlan.recommendedSeatPriceJod} JOD/seat,{' '}
                  {driverPlan.corridor.savingsPercent}% cheaper than solo movement, best pickup at{' '}
                  {liveSignal?.recommendedPickupPoint ??
                    driverPlan.corridor.pickupPoints[0] ??
