        ...
        >
          ...
          >
            ...
            >
              ...
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontWeight: 800, color: C.text, fontSize: '1.1rem' }}>{ride.to}</div>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  label: signal ? 'Live demand' : 'Distance',
                  val: signal ? `${signal.forecastDemandScore}/100` : `${ride.distance} km`,
                },
              ].map(item => (
                <div
                  key={item.label}
                ...
                {corridorPlan && (
                  <div style={{ marginTop: 10, display: 'grid', gap: 6 }}>
                    ...
                    <div style={{ color: DS.sub, fontSize: '0.72rem', lineHeight: 1.55 }}>
                      Solo reference: {corridorPlan.soloReferencePriceJod} JOD | Best pickup:{' '}
