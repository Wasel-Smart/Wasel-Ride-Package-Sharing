...
const PASSENGER_GLOW = 'rgba(8, 125, 255, 0.36)';
    ...
    >
      <style>{`
        .landing-sim-shell {
          ...
          background:
            radial-gradient(circle at 16% 14%, rgba(8,125,255,0.14), rgba(4,18,30,0) 24%),
            radial-gradient(circle at 74% 78%, rgba(255,138,0,0.08), rgba(4,18,30,0) 22%),
        ...
        >
          <defs>
            ...
            >
              ...
              <stop offset="1" stopColor="#087DFF" />
            </linearGradient>
            <linearGradient
            ...
            >
              <stop stopColor="#087DFF" stopOpacity="0.18" />
          ...
          {corridorGeometry.map(corridor => (
            <g key={`${corridor.id}-route`}>
              ...
              <path
                ...
                filter={
                  corridor.highlighted ? 'drop-shadow(0 0 12px rgba(8,125,255,0.30))' : undefined
                }
              />
              <path
                d={corridor.path}
          ...
          {cityPoints.map(city => (
            <g key={city.id}>
              {city.featured ? (
                <circle cx={city.point.x} cy={city.point.y} r="26" fill="rgba(8,125,255,0.07)" />
              ) : null}
              <circle
                cx={city.point.x}
                cy={city.point.y}
              ...
              <circle
                ...
                fill="none"
                stroke={city.featured ? 'rgba(8,125,255,0.34)' : 'rgba(239,248,255,0.16)'}
              />
              <text
