...
export default function MobilityOSCore() {
  ...
  const hottestCorridor =
    snapshot.metrics.hottest_corridor || tx('mobilityOSCore.no_active_pressure');
              ...
              >
                ...
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                  {[
                    ...
                    `${projection.seats_available} ${tx('mobilityOSCore.s_unit')}`,
                    `${projection.cargo_available_kg} ${tx('mobilityOSCore.kg_unit_short')}`,
