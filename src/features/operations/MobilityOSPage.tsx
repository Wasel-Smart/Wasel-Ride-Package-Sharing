...
export default function MobilityOSPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: `${GRAD_AURORA}, radial-gradient(circle at 82% 18%, rgba(255,138,0,0.16), transparent 22%), ${C.bg}`, color: C.text, fontFamily: F, padding: '24px 16px 44px' }}>
