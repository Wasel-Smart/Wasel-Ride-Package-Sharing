        ...
        <section style={panelStyle({ padding: 26, borderRadius: 32 })}>
          ...
          >
            <div style={{ maxWidth: 840, display: 'grid', gap: 12 }}>
              ...
              >
                Mobility OS / Neural Corridor Engine
              </div>
              <h1
                style={{
                  margin: 0,
              ...
              >
                A living operations surface driven by corridor math, visible trust, and Jordan-first
                network logic.
              </h1>
              <p
                style={{
              ...
              >
                Instead of generic dashboard cards, this screen simulates route pressure,
                reliability, package synchrony, and recovery posture so users feel the system is
                intelligently coordinating movement.
              </p>
            ...
            >
              <div>
                ...
                <h2 style={{ margin: '10px 0 6px', fontSize: '1.4rem' }}>
                  Jordan corridor constellation
                </h2>
                <p style={{ margin: 0, color: C.textSub, maxWidth: 620, lineHeight: 1.65 }}>
                  Signal view exposes route health as a legible motion field, while math, fleet, and
                  recovery modes shift the explanation layer without hiding the network.
                </p>
              </div>
          ...
          <div style={{ display: 'grid', gap: 14 }}>
            <div style={panelStyle({ padding: 18, borderRadius: 24 })}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <h3 style={{ margin: 0, fontSize: '1.02rem' }}>Corridor leaderboard</h3>
              </div>
                    ...
                    >
                      <div>
                        ...
                        <div style={{ marginTop: 4, color: C.textMuted, fontSize: '0.82rem' }}>
                          {route.distance} km / ETA {route.etaLive} min
                        </div>
                      </div>
                      <div
                        style={{
            ...
            <div style={panelStyle({ padding: 18, borderRadius: 24 })}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <h3 style={{ margin: 0, fontSize: '1.02rem' }}>Decision engine</h3>
              </div>
              <div style={{ marginTop: 14, display: 'grid', gap: 10 }}>
                {[
