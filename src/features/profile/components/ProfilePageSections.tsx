    ...
    >
      ...
      <button
        ...
        style={{
          padding: '10px 24px',
          borderRadius: 10,
          background: `linear-gradient(135deg,${PROFILE_CYAN},#0057F0)`,
          border: 'none',
          color: '#040C18',
          fontWeight: 700,
          cursor: 'pointer',
      ...
      <div style={{ position: 'relative' }}>
        <div
          style={{
            ...
            fontWeight: 900,
            color: '#040C18',
            boxShadow: '0 0 0 3px rgba(8,125,255,0.35), 0 8px 32px rgba(8,125,255,0.2)',
            overflow: 'hidden',
          }}
        >
          {user.avatar ? (
      ...
      {editingField === 'name' ? (
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', width: '100%', maxWidth: 320 }}>
          <input
            ...
            style={{
              ...
              background: 'rgba(8,125,255,0.07)',
              color: '#EFF6FF',
              fontSize: '0.9rem',
              fontFamily: PROFILE_FONT,
              outline: 'none',
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, flexWrap: 'wrap', marginTop: 8 }}>
            <span style={{ fontSize: '0.66rem', padding: '4px 9px', borderRadius: 999, color: PROFILE_CYAN, background: 'rgba(8,125,255,0.12)', border: '1px solid rgba(8,125,255,0.25)', fontFamily: PROFILE_FONT, fontWeight: 700 }}>
              {roleLabel}
            </span>
