    ...
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <section style={{
          ...
          <h2 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '0.5rem', color: '#EFF6FF' }}>
            Export Your Data
          </h2>
          <p style={{ color: 'rgba(239, 246, 255, 0.7)', marginBottom: '1rem', fontSize: '0.875rem' }}>
        ...
        <section style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#EFF6FF' }}>
