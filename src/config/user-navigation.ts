...
export const CORE_NAV_ITEMS: CoreNavItem[] = [
  ...
  {
    id: 'mobility-os',
    label: 'Mobility OS (Network)',
    labelAr: 'شبكة التنقل',
    path: '/mobility-os',
    description: 'Explore the live mobility network and connected corridors',
    descriptionAr: 'استكشف شبكة التنقل المباشرة والمسارات المتصلة',
    accent: 'cyan',
  },
  {
    id: 'bus',
