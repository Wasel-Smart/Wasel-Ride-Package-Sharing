...
export function isRecoverableError(error: unknown): boolean {
  ...
  // When the API circuit breaker is OPEN (edge transport repeatedly failing),
  // treat it as recoverable so the direct-Supabase fallback can take over
  // instead of surfacing the raw "Circuit breaker api-calls is OPEN" error.
