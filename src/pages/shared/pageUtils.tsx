...
export function PageShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div
      style={{
        minHeight: '100vh',
        background: `radial-gradient(circle at 12% 10%, rgba(8,125,255,0.16), transparent 24%), radial-gradient(circle at 88% 6%, rgba(255,138,0,0.1), transparent 22%), radial-gradient(circle at 80% 86%, rgba(57,199,44,0.1), transparent 24%), ${DS.bg}`,
        fontFamily: DS.F,
    ...
    >
      ...
      <div
        style={{
          position: 'fixed',
          inset: 0,
          background: 'radial-gradient(circle at 50% 0%, rgba(8,125,255,0.08), transparent 38%), radial-gradient(circle at 82% 76%, rgba(255,138,0,0.05), transparent 24%)',
          pointerEvents: 'none',
        }}
      />
      <style>{`
