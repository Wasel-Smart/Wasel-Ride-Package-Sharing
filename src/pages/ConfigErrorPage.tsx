  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {tx('configErrorPage.configuration_error')}
        </div>

        <h2 style={{ fontSize: '1.6rem', fontWeight: 900, color: '#EFF6FF', margin: '0 0 16px' }}>
          {tx('configErrorPage.environment_configuration_errors')}
        </h2>
        ...
        >
          {tx('configErrorPage.please_contact_support_or_check_your_environment_variables')}
        </p>
        ...
        >
          ...
          <ol style={{ margin: 0, paddingLeft: 20 }}>
            <li>{tx('configErrorPage.go_to_your_vercel_project_dashboard')}</li>
            <li>{tx('configErrorPage.navigate_to_settings_environment_variables')}</li>
            <li>{tx('configErrorPage.add_the_missing_variables_listed_above')}</li>
            <li>{tx('configErrorPage.redeploy_your_application')}</li>
          </ol>
        </div>
      </div>
    </div>
