...
export const PAGE_DS = {
  bg:    'var(--service-background, #F8FAFC)',
  card:  'var(--service-card, #FFFFFF)',
  card2: 'var(--service-card-muted, #F8FAFC)',
  card3: 'var(--service-card-strong, #F1F5F9)',
  panel: '#F8FAFC',
  field: '#FFFFFF',

  border:  'var(--border, #E2E8F0)',
  borderH: 'var(--border-strong, #CBD5E1)',
  ...
  gradHero: 'var(--service-head-background)',
  glowC:    'rgba(58, 124, 165, 0.16)',
  glowT:    'rgba(91, 155, 213, 0.14)',

  sectionHeadBg: 'var(--service-head-background)',
  cardGrad:      '#FFFFFF',
