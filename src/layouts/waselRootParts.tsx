    ...
    <div ref={ref} style={{ position: 'relative' }}>
      <button
        ...
        style={{
          ...
          padding: '0 10px',
          borderRadius: R.md,
          background: open ? 'rgba(8,125,255,0.12)' : PANEL_SOFT,
          ...
          boxShadow: open ? '0 10px 24px rgba(8,125,255,0.16)' : 'none',
        }}
      >
          ...
          {popular.map((code) => (
            <button
              ...
              style={{
                ...
                padding: '8px 12px',
                background:
                  current === code ? 'rgba(8,125,255,0.12)' : 'transparent',
                border: 'none',
                cursor: 'pointer',
                fontSize: '0.8rem',
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: '0 12px',
        borderRadius: R.full,
        background: online ? 'rgba(57,199,44,0.16)' : PANEL_SOFT,
        border: `1.5px solid ${
          online ? 'rgba(57,199,44,0.4)' : 'rgba(255,255,255,0.14)'
        }`,
        cursor: 'pointer',
        display: 'flex',
        alignItems: 'center',
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${PANEL_BORDER}`,
        borderRadius: 18,
        boxShadow: `${PANEL_SHADOW}, 0 0 0 1px rgba(8,125,255,0.06)`,
        padding: 12,
        minWidth: 380,
        display: 'grid',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '12px 14px',
                  borderRadius: 16,
                  background: isCurrent ? 'rgba(8,125,255,0.11)' : PANEL_SOFT,
                  border: `1px solid ${
    ...
    <div ref={ref} style={{ position: 'relative' }}>
      <button
        ...
        style={{
          ...
          borderRadius: 9999,
          background: open ? 'rgba(8,125,255,0.1)' : 'rgba(255,255,255,0.06)',
          border: `1px solid ${open ? C.borderHov : C.border}`,
          cursor: 'pointer',
      ...
      >
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'linear-gradient(135deg,#087DFF 0%, #0048E8 58%, #FF8A00 100%)',
        ...
        >
          <div
            style={{
              padding: '14px 16px',
              background:
                'linear-gradient(180deg, rgba(8,125,255,0.08), rgba(255,255,255,0.02))',
