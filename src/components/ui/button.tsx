...
>(
  (
    ...
    // Store per-element cleanup callbacks without polluting the DOM node type.
    const feedbackCleanups = React.useRef(new WeakMap<Element, () => void>());
    ...
    React.useImperativeHandle(ref, () => {
      ...
      if (!current) {
        throw new Error('Button ref is not attached');
      }
      return current;
    });
