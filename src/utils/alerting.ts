...
class AlertingSystem {
  ...
  private triggerAlert(alert: Alert): void {
    ...
    logger[logLevel]('Alert triggered', {
      alertId: sanitizeLogMessage(alert.id),
      severity: sanitizeLogMessage(alert.severity),
      title: sanitizeLogMessage(alert.title),
      message: sanitizeLogMessage(alert.message),
      metric: sanitizeLogMessage(alert.metric),
      value: alert.value,
    });
  ...
  acknowledgeAlert(alertId: string): void {
    ...
    if (alert) {
      ...
      logger.info('Alert acknowledged', { alertId: sanitizeLogMessage(alertId) });
    }
  }
