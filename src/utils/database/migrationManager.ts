...
export class MigrationManager {
  ...
  /**
   * Rolls back a migration after creating a safety backup.
   * This is the recommended procedure for critical migrations.
   */
  async rollbackWithBackup(version: string): Promise<{ backupId: string }> {
