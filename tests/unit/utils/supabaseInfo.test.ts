...
describe('supabase public config', () => {
  ...
  it('does not provide a checked-in public fallback when env vars are missing', async () => {
  ...
  it('keeps explicit Supabase env values when legacy e2e flags are present', async () => {
